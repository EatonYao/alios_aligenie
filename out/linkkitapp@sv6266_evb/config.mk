...
base64_DEFINES          := 
vfs_device_DEFINES          := 
linkkitapp_CFLAGS           := -DCONFIG_YWSS -DBUILD_AOS -DAWSS_SUPPORT_STATIS -USYSINFO_OS_VERSION -DSYSINFO_OS_VERSION=\"\" -USYSINFO_PRODUCT_MODEL -DSYSINFO_PRODUCT_MODEL=\"ALI_AOS_SV6266_EVB\" -USYSINFO_DEVICE_NAME -DSYSINFO_DEVICE_NAME=\"SV6266_EVB\" -std=gnu99 -fgnu89-inline -Wno-format -mcpu=n10 -march=v3 -mcmodel=large -DPORTING_DEBUG -DMINIMAL_STACK_SIZE=128 -DTCPIPSTACK_EN -malign-functions -falign-functions=4 -ffunction-sections -fdata-sections -fno-builtin -Wno-attributes --short-enums -w -Wall -Wno-unused-function -Wno-unused-variable -Wno-unused-but-set-variable -DLWIP_NOASSERT -fno-delete-null-pointer-checks       -DSYSINFO_APP_VERSION=\"app-1.0.1\"    -DSYSINFO_KERNEL_VERSION=\"AOS-R-1.3.4\"        -DLOG_SIMPLE              -ggdb -O2 -fno-common  -DAOS_SDK_VERSION_MAJOR=3 -DAOS_SDK_VERSION_MINOR=2 -DAOS_SDK_VERSION_REVISION=3 -Iout/linkkitapp@sv6266_evb/resources/ -DPLATFORM=\"sv6266_evb\" 
